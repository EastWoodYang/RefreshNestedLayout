...
public class SampleRecyclerViewPullToRefresh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_recycler_view_pull_to_refresh);  // set pullToRefresh mode
