...
public class SampleRecyclerViewRefreshableViewAttr_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_recycler_view_refreshable_view_attr_1);  // set refreshable_view AttributeSet
